...
import { RotateCcw, BoxSelect, Save, VectorSquare, Scan } from 'lucide-react'
...
export function ActionsPanel({ onResetView, onExport, onDefineArea, disabled }: ActionsPanelProps) {
  return (
