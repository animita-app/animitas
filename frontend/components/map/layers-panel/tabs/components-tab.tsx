import { Eye, EyeOff, Plus, X, ChartBarDecreasing, ChartColumn, ListOrdered } from 'lucide-react'
...
export function ComponentsTab({ selectedLayer, onOpenForm, onToggleVisibility, onRemove }: ComponentsTabProps) {
  return (
