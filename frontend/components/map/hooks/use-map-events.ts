...
import { CHILE_BOUNDS } from "./use-map-initialization";
...
export function useMapEvents(
  { map, isMapReady, focusedHeritageSiteId, onLayerClick }: UseMapEventsProps,
) {
  ...
  useEffect(() => {
    ...
    const onLayerFeatureClick = (
      ...
      // Identify layer
      const layerId = feature.layer.id.replace(
        /-inner|-outer|-poly|-heatmap/,
        "",
      );
