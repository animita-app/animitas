...
export function SearchInput({
  ...
  return (
    <div className='box-border px-3 pr-2 flex items-center gap-1.5 w-full md:w-auto'>
      <SearchIcon size={16} className="text-muted-foreground pointer-events-none flex-shrink-0" />
        ...
        <Popover open={isOpen} onOpenChange={onOpenChange}>
          <PopoverTrigger asChild>
            <input
              ...
              type="text"
              className={cn(
                'w-full h-[30px] px-1 focus:outline-none bg-transparent text-sm',
      ...
      <Button
        ...
        disabled={isLoading}
        className={cn(
          '!h-[30px] !w-[30px] rounded-full text-muted-foreground ml-auto mr-1.5',
