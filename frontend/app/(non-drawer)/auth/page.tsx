...
type Step = 'phone' | 'code' | 'name' | 'username' | 'picture' | 'done'
...
export default function AuthPage() {
  ...
  const stepNumber = step === 'phone' ? 1 : step === 'code' ? 2 : step === 'name' ? 3 : step === 'username' ? 4 : 5

  return (
    <div className="flex flex-col min-h-screen bg-background">
      <div className="max-w-md mx-auto w-full p-8 flex-1 flex flex-col">
        <div className="flex items-center justify-between gap-4 mb-8">
          <span className="sr-onlytext-xs text-muted-foreground">
            {AUTH_COPY.stepFormat(stepNumber, 5)}
          </span>
        ...
        <div className="mb-8">
          <h1 className="text-xl font-medium mb-2">
            {step === 'phone' ? AUTH_COPY.steps[1].title : step === 'code' ? AUTH_COPY.steps[2].title : step === 'name' ? AUTH_COPY.steps[3].title : step === 'username' ? AUTH_COPY.steps[4].title : '¡Registro exitoso!'}
          </h1>
      ...
      <div className="fixed bottom-0 inset-x-0 p-6 max-w-md mx-auto space-y-2">
        <p className="text-center text-balance text-xs text-muted-foreground pb-4">
