...
export const SEED_SITES: Site[] = [
  {
    ...
    "story": "El relato que se ofrece fue entregado por el periodista Canut de Bon U.\n\"El Maucho Antonio\" era un clandestino en la vieja Arica, por allá por los finales de los años cuarenta, donde los dineros se jugaban todas las noches, enriqueciendo de pronto a algunos, dejando en la ruina a los más.\nUna noche, de esas agradablemente templadas de Arica, un militar de apellido Gómez ganó el dinero de los parroquianos que se habían dado cita como acostumbraban, en la penumbra humosa de \"El Maucho Antonio\".\nCuando ya taltaba poco para el nuevo día, resolvió irse tan lleno de dinero como estaba. Encaminó sus pasos por la calle Patricio Lynch, hacia el norte, seguramente con algo de alcohol y cigarrillo en su cuerpo y en su mente.\nSu destino, sin embargo, no iba a estar acompañado por la felicidad que íntimamente lo había invadido al sentirse ganador de la suerte. Un golpe seco en la cabeza lo aturdió, o lo mató -nunca llegó a saberse con certeza- y fue robado.\nEl hechor, sin embargo, no quedaría tranquilo con esto y arrastró su cuerpo hasta la línea del tren que pasaba cercano. Allí quedó abandonado, en la esquina de Patricio Lynch con Chacabuco, por donde a las siete de la mañana habría de pasar, como todos los días a esa hora, la locomotora que salía desde \"El Chinchorro\" para ir a buscar a los obreros ferroviarios - los \"chinchorrinos\" - que debían ir a su trabajo.\nLlegaba hasta la calle Chiloé y posteriormente comenzaba a encaramarse hasta alcanzarla punta del Morro. Este trayecto se repetía hasta el mediodía y por la tarde para llevar y traer a los operarios.\nEl pito, familiar para los vecinos, acusó la presencia de la locomotora, casi puntualmente. Su maquinista habría de contar después que, al pasar por Lynch y Chacabuco, sintió un golpe duro en la máquina, pero no percibió con claridad de qué se trataba, por lo que siguió la marcha.\nLos hechos fríos, sin embargo, acusanían la verdad en los mismos momentos en que la ciudad comenzaba a despertar: el cuerpo del infortunado militar había sido despedazado por el paso de la pesada mole de hierro.\nUno de los parroquianos de \"El Maucho Antonio\", que había abandonado el local sólo momentos después que lo había hecho Gómez, fue detenido horas más tarde, al cabo de intensas investigaciones policiales y en medio de la conmoción de toda la ciudad.\nEra apodado \"El Manguera\", quien fue sometido a intensos actualmente fallecido, pasó a ser toda una historia de especulaciones entre los ariqueños y poco se le vio después en los locales nocturnos de la ciudad.\nSe trata de uno de los casos más misteriosos que hayan ocurrido. ¿Fue accidente ferroviario por haber estado bebido? ¿Se quedó dormido en la vía férrea? ¿Lo mataron y colocaron en la línea para que fuera atropellado?\nANIMITA\nSe rodeó toda esta circunstancia de incertidumbres hasta que la espontaneidad popular instaló un día lunes -en que ocurrió todo- una vela encendida en el lugar de los hechos. Las velas se multiplicaron y manos desconocidas levantaron después una animita, que es visitada todos los días, pero especialmente al comienzo de cada semana, cuando muchos llegan con flores y con velas, pero también con oración.\nAl Alcalde Manuel Castillo, que permaneció trece años en el cargo, no le gustó la \"animita\", y un día ordenó retirarla, pues consideró que afeaba el Parque Ibáñez donde se levanta un monumento al ex Presidente de la República. La \"animita\" fue llevada dos cuadras más arriba, pero la fuerza popular la bajaba a su lugar original.\nSe convirtió esto en un verdadero partido que la ciudad seguía con todo tipo de reacciones. Cuando la \"animita\" subía, los ariqueños decían \"uno a cero, para el alcalde\"; al bajarla: \"empate\".\nY así siguió la historia, hasta quedar el ánima del soldado Gómez en su lugar de origen, la muy conocida esquina de General Lagos y Chacabuco: Cuando se la visitó en 1989, se recogieron versiones que inciden con ligeras variantes.\n\"La historia verdadera perdurará en quienes la conocieron en la misma época\", pero en la actualidad es la \"animita\" más conocida y venerada por la ciudad.\nUna de estas razones ha gravitado para que se le elevara a \"Santo Popular\". Su templete ennegrecido por el humo de las velas no es nada ostentoso, se encuentra a una orilla de la calzada, pero al caer la noche, a lo lejos, da la impresión de una fogata.\nEn la ocasión en que se recogían estos datos, una señora dijo: \"Esta animita es 'perseguidora', el señor Alcalde que la quería borrar se fue de Arica y dicen que sufrió una enfermedad que lo tiene inválido\".",
